...
int main() {
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glBindVertexArray(VAO);
	    //mesa que mas apluauda
	    model = glm::mat4(1.0f);
		model = glm:: scale(model, glm::vec3(2.0f, 0.1f, 2.0f)); // ancho, alto, profundidad
		...
		//pata 1 de la mesa que mas aplauda
		model = glm::mat4(1.0f);
		model = glm::scale(model, glm::vec3(0.1f, 2.2f, 0.1f)); // ancho, alto, profundidad
		model = glm::translate(model, glm::vec3(8.0f, 0.0f, 8.0f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);

		//pata 2 de la mesa que mas aplauda
		model = glm::mat4(1.0f);
		...
		//pata 3 de la mesa que mas aplauda
		model = glm::mat4(1.0f);
		model = glm::scale(model, glm::vec3(0.1f, 2.2f, 0.1f));
		model = glm::translate(model, glm::vec3(8.0f, 0.0f, -8.0f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		...
		//pata 4 de la mesa que mas aplauda
		model = glm::mat4(1.0f);
		model = glm::scale(model, glm::vec3(0.1f, 2.2f, 0.1f));
		model = glm::translate(model, glm::vec3(-8.0f, 0.0f, -8.0f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
